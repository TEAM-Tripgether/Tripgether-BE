...
-----------------------------------------------------------------
            ...
            IF
                ...
                ALTER TABLE public.member
                    DROP COLUMN is_service_terms_agreed;
            END IF;
            ...
            IF
                ...
                ALTER TABLE public.member
                    RENAME COLUMN marketing_agreed TO is_marketing_agreed;
            ELSIF
                NOT EXISTS (SELECT 1
                            FROM information_schema.columns
                            WHERE table_schema = 'public'
                ...
                ALTER TABLE public.member
                    ADD COLUMN is_marketing_agreed BOOLEAN DEFAULT false;
            END IF;
            ...
            IF
                ...
                ALTER TABLE public.member
                    ADD COLUMN onboarding_step VARCHAR(20);
            END IF;
