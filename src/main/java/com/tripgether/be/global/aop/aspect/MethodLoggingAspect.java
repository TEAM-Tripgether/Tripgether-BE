package com.tripgether.be.global.aop.aspect;

import com.tripgether.be.global.aop.annotation.LogExecutionTime;
...
public class MethodLoggingAspect {
     ...
     */
    @Around("execution(* com.tripgether.be.domain.*.controller.*.*(..)) || " +
            "execution(* com.tripgether.be.domain.*.service.*.*(..)) || " +
            "execution(* com.tripgether.be.domain.*.repository.*.*(..))")
